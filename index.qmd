...
region_order = ['North America', 'South Asia',  'Middle East & North Africa', 'East Asia & Pacific', 'Latin America & Caribbean', 'Sub-Saharan Africa', 'Europe & Central Asia']
...
bar1 = alt.Chart(region_count).mark_bar().encode(
    ...
    y=alt.Y('count:Q', axis=alt.Axis(title="Country Count")),
