...
In the global pursuit of gender equality, education stands out as both a fundamental right and a pivotal area of progress and challenge [1] .The accessibility of education for females, particularly women, is closely associated with several economic metrics, such as GDP per capita, GNI per capita, and the fiscal priorities of the government [2]. 

Throughout history, women have faced significant barriers to equitable access not only to education but also to the fundamental freedom to control their own lives.These challenges have both directly and indirectly fueled the ongoing global gaps in educational attainment. Declaring that everyone has the right to education is a bold and basic right, as stated in Article 26 of the Universal Declaration of Human Rights [3]. This acknowledgement acts as a call to action to overcome the remaining obstacles that impede women from enjoying their right to the fullest extent possible, as well as a reminder of the progress that has been done.By examining these disparities and understanding their deep-rooted causes, we can better advocate for and implement strategies that ensure all women have the opportunity to learn, grow, and participate fully in society. 
...
- How do literacy rates correlate with population growth across different regions and time periods?
- How does resource allocation to education impact literacy rates?
- What role do literacy and education play in economic growth?
- To what extent is gender equality present in educational access and outcomes?
- How do education trends reflect employment trends, especially regarding gender?
- What barriers hinder gender equality in education?
...
![Labor-plot](tiana/code/labor_barplot.png)
...
![Line-plot](tiana/code/line_plot.png)
